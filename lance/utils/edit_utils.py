...
import numpy as np
import math
from InfEdit import ptp_utils
from InfEdit import seq_aligner
from InfEdit import utils
...
class InfEditPipe:
    ...
    def __init__(
            ...
            cross_replace_steps: Optional[float] = 0.7,
...
def run_and_display(
    ...
    ori_prompt = ori_prompt[0]
    cur_prompt = cur_prompt
    image = InfEditPipe(
        image_path=img_path,
        source_prompt=ori_prompt,
        target_prompt=cur_prompt,
